...
<div class="container">
    ...
    <form:form method="POST" modelAttribute="pollForm">
        <div class="form-group">
            ...
            <form:input path="question" type="text" id="question" required="required" placeholder="Enter poll question"/>
        </div>
    ...
    <div class="nav-links">
        <a href="<c:url value="/index/viewPoll/${poll.id}"/>" class="nav-link">Cancel and Return to Poll</a>
